...
public class HealthBar : MonoBehaviour
{
    ...
    private void UpdateText(float currentHealth, int maxHealth)
    {
        ...
        this.currentHealth ??= FindObjectsOfType<TextMeshProUGUI>().First(tmp => tmp.name == "CurrentHealthText");
        ...
        this.maxHealth ??= FindObjectsOfType<TextMeshProUGUI>().First(tmp => tmp.name == "MaxHealthText");
